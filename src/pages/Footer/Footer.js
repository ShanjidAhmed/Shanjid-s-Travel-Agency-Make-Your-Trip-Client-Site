            ...
            <footer>
                <div className="top-footer row justify-content-center">
                    <div className="about-us footer-coloum col-lg-3 col-sm-7 col-md-5">
                        <h4>About Us</h4>
                        <hr />
                        <p>Shanjid's Travel Agency is an exceptional travelling organisation. Our diverse selection includes hikinh, coving, glacier walks, ice climbing, mountain climbing etc!</p>
                    </div>
